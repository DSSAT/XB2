 ...
 * @author Jazzy
 */
public class PlantingDialog extends javax.swing.JDialog {

    /** Creates new form CultivarDialog */
    private Integer level;

    public PlantingDialog()
    {
        super();
    ...
    public PlantingDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jXTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Level", "Description", "Planting Date"
            }
        ) {
