...
/*
 * FertilizerFrame.java
 *
 * Created on Mar 12, 2010, 4:28:33 PM
 */
 ...
 * @author Jazzy
 */
public class FertilizerFrame extends javax.swing.JInternalFrame {
    ...
    private void jTabbedPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPane1MouseClicked
        if(evt.getClickCount() == 1) {
            if(jTabbedPane1.getSelectedIndex() == jTabbedPane1.getTabCount()-1)   // Add New App
            {
                ...
                if(r.length() > 0) {
                    ...
                    Fertilizer fertil = new Fertilizer(r);
        ...
        } else if(evt.getClickCount() == 2 && jTabbedPane1.getSelectedIndex() < jTabbedPane1.getTabCount()-1) // Edit
        {
            ...
            Fertilizer fertil = FileX.fertilizerList.GetAt(jTabbedPane1.getSelectedIndex());
            fertil.FERNAME = r;
        }
    ...
    private void mnuRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuRemoveActionPerformed
        if(JOptionPane.showConfirmDialog(new JXFrame(), "Do you want to delete this level") == 0){
            ...
            FileX.fertilizerList.RemoveAt(index);
    ...
    private void LoadFetilizer() {
        for(int n = 0;n < FileX.fertilizerList.GetSize();n++){
            int newLevel = n + 1;
            Fertilizer fertil = FileX.fertilizerList.GetAt(n);
            String newTitle = "<html><p align='center'>Level " + newLevel + "<br>" + fertil.FERNAME + "</p></html>";
            jTabbedPane1.insertTab(newTitle, null, new FertilizerPanel(fertil), "", jTabbedPane1.getTabCount()-1);
        }
