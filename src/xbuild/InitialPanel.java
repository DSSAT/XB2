 ...
 * InitialPanel.java
 *
 * Created on Mar 15, 2010, 11:58:51 AM
 */
 ...
 * @author Jazzy
 */
public class InitialPanel extends javax.swing.JPanel implements KeyListener {
    ...
    public InitialPanel(InitialCondition init) {
        initComponents();
            ...
            dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                ...
                public void windowClosed(WindowEvent e) {
                    ...
                    if(initApp != null){
                        ...
                        Vector vector = SetRow(initApp);
                        for(int n = 0;n < vector.size();n++)
                            model.setValueAt(vector.get(n), tbProfile.getSelectedRow(), n);
                    }
                    dialog.SetNull();
                }
            });
    ...
    private Vector SetRow(InitialConditionApplication initApp) {
