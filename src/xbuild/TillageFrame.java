 ...
 * TillageFrame.java
 *
 * Created on Mar 13, 2010, 10:49:09 AM
 */
...
public class TillageFrame extends javax.swing.JInternalFrame {
    ...
    private void jTabbedPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPane1MouseClicked
        ...
        } else if(evt.getClickCount() == 2 && jTabbedPane1.getSelectedIndex() < jTabbedPane1.getTabCount()-1) // Edit
        {
            ...
            Tillage tillage = FileX.tillageList.GetAt(jTabbedPane1.getSelectedIndex());
            tillage.TNAME = r;
        }
    ...
    private void mnuRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuRemoveActionPerformed
        if(JOptionPane.showConfirmDialog(new JXFrame(), "Do you want to delete this level") == 0){
            ...
            FileX.tillageList.RemoveAt(index);
    ...
    private void LoadTillage() {
        for(int n = 0;n < FileX.tillageList.GetSize();n++){
            int newLevel = n + 1;
            Tillage tillage = FileX.tillageList.GetAt(n);
            String newTitle = "<html><p align='center'>Level " + newLevel + "<br>" + tillage.TNAME + "</p></html>";
            jTabbedPane1.insertTab(newTitle, null, new TillagePanel(tillage), "", jTabbedPane1.getTabCount()-1);
        }
