...
/*
 * IrrigationFrame.java
 *
 * Created on Mar 12, 2010, 2:10:35 PM
 */
 ...
 * @author Jazzy
 */
public class IrrigationFrame extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("<html><p align='center'>Add New Level<br>Click Here</p></html>", jXPanel1);
    ...
    private void jTabbedPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPane1MouseClicked
        if(evt.getClickCount() == 1) {
            if(jTabbedPane1.getSelectedIndex() == jTabbedPane1.getTabCount()-1)   // Add New App
            {
                ...
                if(r.length() > 0) {
                    ...
                    Irrigation irrig = new Irrigation(r);
        ...
        } else if(evt.getClickCount() == 2 && jTabbedPane1.getSelectedIndex() < jTabbedPane1.getTabCount()-1) // Edit
        {
            ...
            Irrigation irrig = FileX.irrigations.GetAt(jTabbedPane1.getSelectedIndex());
            irrig.IRNAME = r;
        }
    ...
    private void mnuRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuRemoveActionPerformed
        if(JOptionPane.showConfirmDialog(new JXFrame(), "Do you want to delete this level") == 0){
            ...
            FileX.irrigations.RemoveAt(index);
    ...
    private void loadIrrigation() {
        for(int n = 0;n < FileX.irrigations.GetSize();n++){
            int newLevel = n + 1;
            Irrigation irrig = FileX.irrigations.GetAt(n);
            String newTitle = "<html><p align='center'>Level " + newLevel + "<br>" + irrig.IRNAME + "</p></html>";
            jTabbedPane1.insertTab(newTitle, null, new IrrigationPanel(irrig), "", jTabbedPane1.getTabCount()-1);
        }
