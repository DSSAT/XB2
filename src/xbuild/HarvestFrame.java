 ...
 * HarvestFrame.java
 *
 * Created on Mar 13, 2010, 2:34:04 PM
 */
 ...
 * @author Jazzy
 */
public class HarvestFrame extends javax.swing.JInternalFrame {
    ...
    private void jTabbedPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPane1MouseClicked
        if(evt.getClickCount() == 1) {
            if(jTabbedPane1.getSelectedIndex() == jTabbedPane1.getTabCount()-1)   // Add New App
            {
                ...
                if(r.length() > 0) {
                    ...
                    Harvest harvest = new Harvest(r);
                    FileX.harvestList.AddNew(harvest);

                    jTabbedPane1.insertTab(newTitle, null, new HarvestPanel(harvest), "", jTabbedPane1.getTabCount()-1);
        ...
        } else if(evt.getClickCount() == 2 && jTabbedPane1.getSelectedIndex() < jTabbedPane1.getTabCount()-1) // Edit
        {
            ...
            Harvest harvest = FileX.harvestList.GetAt(jTabbedPane1.getSelectedIndex());
            harvest.HNAME = r;
        }
...
//            FileX.harvestList.AddNew(harvest);
    ...
    private void mnuRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuRemoveActionPerformed
        if(JOptionPane.showConfirmDialog(new JXFrame(), "Do you want to delete this level") == 0){
            ...
            FileX.harvestList.RemoveAt(index);
    ...
    private void LoadHarvest() {
        for(int n = 0;n < FileX.harvestList.GetSize();n++){
            int newLevel = n + 1;
            Harvest harvest = FileX.harvestList.GetAt(n);
            String newTitle = "<html><p align='center'>Level " + newLevel + "<br>" + harvest.HNAME + "</p></html>";
            jTabbedPane1.insertTab(newTitle, null, new HarvestPanel(harvest), "", jTabbedPane1.getTabCount()-1);
        }
