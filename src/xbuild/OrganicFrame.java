 ...
 * OrganicFrame.java
 *
 * Created on Mar 13, 2010, 9:14:47 AM
 */
 ...
 * @author Jazzy
 */
public class OrganicFrame extends javax.swing.JInternalFrame {
    ...
    private void jTabbedPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPane1MouseClicked
        ...
        } else if(evt.getClickCount() == 2 && jTabbedPane1.getSelectedIndex() < jTabbedPane1.getTabCount()-1) // Edit
        {
            ...
            Organic organic = FileX.organicList.GetAt(jTabbedPane1.getSelectedIndex());
            organic.RENAME = r;
        }
    ...
    private void mnuRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuRemoveActionPerformed
        if(JOptionPane.showConfirmDialog(new JXFrame(), "Do you want to delete this level") == 0){
            ...
            FileX.organicList.RemoveAt(index);
    ...
    private void LoadOrganic() {
        for(int n = 0;n < FileX.organicList.GetSize();n++){
            int newLevel = n + 1;
            Organic organic = FileX.organicList.GetAt(n);
            String newTitle = "<html><p align='center'>Level " + newLevel + "<br>" + organic.RENAME + "</p></html>";
            jTabbedPane1.insertTab(newTitle, null, new OrganicPanel(organic), "", jTabbedPane1.getTabCount()-1);
        }
