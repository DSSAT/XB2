 ...
 * PlantingFrame.java
 *
 * Created on Mar 12, 2010, 9:57:00 AM
 */
 ...
 * @author Jazzy
 */
public class PlantingFrame extends javax.swing.JInternalFrame {

    /** Creates new form PlantingFrame */
    protected String PLME;
    protected String PLDS;
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("<html><p align='center'>Add New Level<br>Click Here</p></html>", jXPanel4);
    ...
    private void jTabbedPane1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTabbedPane1MouseClicked
        if(evt.getClickCount() == 1) {
            if(jTabbedPane1.getSelectedIndex() == jTabbedPane1.getTabCount()-1)   // Add New App
            {
                ...
                if(r.length() > 0) {
                    ...
                    Planting plant = new Planting(r);
                    FileX.plantings.AddNew(plant);

                    jTabbedPane1.insertTab(newTitle, null, new PlantingPanel(plant), "", jTabbedPane1.getTabCount()-1);
        ...
        } else if(evt.getClickCount() == 2 && jTabbedPane1.getSelectedIndex() < jTabbedPane1.getTabCount()-1) // Edit
        {
            ...
            Planting plant = FileX.plantings.GetAt(jTabbedPane1.getSelectedIndex());
            plant.PLNAME = r;
        }
    ...
    private void mnuCopyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuCopyActionPerformed
        ...
        if (r.length() > 0) {
            ...
            Planting plant = FileX.plantings.Clone(jTabbedPane1.getSelectedIndex(), r);
            FileX.plantings.AddNew(plant);
    ...
    private void mnuRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuRemoveActionPerformed
        if(JOptionPane.showConfirmDialog(new JXFrame(), "Do you want to delete this level") == 0){
            ...
            FileX.plantings.RemoveAt(index);
    ...
    private void LoadPlantingAll() {
        for(int n = 0;n < FileX.plantings.GetSize();n++){
            int newLevel = n + 1;
            Planting planting = FileX.plantings.GetAt(n);
            String newTitle = "<html><p align='center'>Level " + newLevel + "<br>" + planting.PLNAME + "</p></html>";

            jTabbedPane1.insertTab(newTitle, null, new PlantingPanel(planting), "", jTabbedPane1.getTabCount()-1);
        }
