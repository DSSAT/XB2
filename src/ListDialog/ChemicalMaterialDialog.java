 ...
 * @author Jazzy
 */
public class ChemicalMaterialDialog extends javax.swing.JDialog {

    /** Creates new form FertilizerListDialog */

    private ChemicalMaterial chem;// = new FertilizerMethod();

    public ChemicalMaterialDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public ChemicalMaterial GetSelected() {
        return chem;
    }

    private void AddDataToTable() {
        DefaultTableModel tbModel = (DefaultTableModel) jXTable1.getModel();
        for(ChemicalMaterial chem : ChemicalMaterialList.GetAll())
        {
            tbModel.addRow(new Object[]{chem.Code, chem.Description});
        }
    }
