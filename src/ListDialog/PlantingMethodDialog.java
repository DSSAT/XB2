...
/*
 * PlantingMethodDialog.java
 *
 * Created on 28 ก.พ. 2553, 21:43:54
 */
 ...
 * @author Jazzy
 */
public class PlantingMethodDialog extends javax.swing.JDialog {

    /** Creates new form PlantingMethodDialog */

    PlantingMethod plantingMethod = new PlantingMethod();

    public PlantingMethodDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public PlantingMethod GetSelected()
    {
    ...
    private void AddDataToTable() {
        DefaultTableModel tbModel = (DefaultTableModel) jXTable1.getModel();
        PlantingMethodList.GetAll().forEach(p ->
        {
