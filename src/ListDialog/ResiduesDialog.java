 ...
 * @author Jazzy
 */
public class ResiduesDialog extends javax.swing.JDialog {

    /** Creates new form FertilizerListDialog */

    private Residues res;

    public ResiduesDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void AddDataToTable() {
        DefaultTableModel tbModel = (DefaultTableModel) jXTable1.getModel();
        ResiduesList.GetAll().forEach(r ->
        {
            tbModel.addRow(new Object[]{r.Code, r.Description});
        });
    }
