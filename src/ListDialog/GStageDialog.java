 ...
 * @author Jazzy
 */
public class GStageDialog extends javax.swing.JDialog {

    /** Creates new form FertilizerListDialog */

    private GrowthStage gStage;// = new FertilizerMethod();
    private Crop crop;

    public GStageDialog(java.awt.Frame parent, boolean modal, Crop crop) {
        super(parent, modal);
        initComponents();
        this.crop = crop;
    ...
    public GrowthStage GetSelected()
    {
        return gStage;
    }
    ...
    private void AddDataToTable() {
        DefaultTableModel tbModel = (DefaultTableModel) jXTable1.getModel();
        for(GrowthStage g : GrowthStageList.GetAt(crop))
        {
            tbModel.addRow(new Object[]{g.Code, g.Name, g.Description});
        }
    }
