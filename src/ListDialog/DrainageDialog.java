 ...
 * @author Jazzy
 */
public class DrainageDialog extends javax.swing.JDialog {

    /** Creates new form FertilizerListDialog */

    protected Drainage drain;

    public DrainageDialog(java.awt.Frame parent, boolean modal, Drainage selDrain) {
        super(parent, modal);
        initComponents();

        AddDataToTable(selDrain);
    ...
    private void jXTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jXTable1MouseClicked
        if(evt.getClickCount() == 2) {
            ...
            drain.Code = (String) tbModel.getValueAt(row, 0);
            drain.Description = (String) tbModel.getValueAt(row, 1);
            dispose();
        }
}//GEN-LAST:event_jXTable1MouseClicked

    public Drainage GetSelected()     {
        return drain;
    }

    private void AddDataToTable(Drainage selDrain) {
        DefaultTableModel tbModel = (DefaultTableModel) jXTable1.getModel();
        ListSelectionModel selModel = null;

        int i = 0;
        for(Drainage dr : DrainageList.GetAll())
        {
            tbModel.addRow(new Object[]{dr.Code, dr.Description});

            if(selDrain != null){
                if(selDrain.Code.equals(dr.Code))
                {
