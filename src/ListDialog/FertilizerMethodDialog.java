 ...
 * @author Jazzy
 */
public class FertilizerMethodDialog extends javax.swing.JDialog {

    /** Creates new form FertilizerListDialog */

    private FertilizerMethod fertil;// = new FertilizerMethod();

    public FertilizerMethodDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public FertilizerMethod GetSelected()
    {
        return fertil;
    }
    ...
    private void AddDataToTable() {
        DefaultTableModel tbModel = (DefaultTableModel) jXTable1.getModel();
        for(FertilizerMethod fer : FertilizerMethodList.GetAll())
        {
            tbModel.addRow(new Object[]{fer.Code, fer.Description});
        }
    }
